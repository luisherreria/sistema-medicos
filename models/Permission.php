...
class Permission
{
    ...
    private static function _routeMap()
    {
        return [
            ...
            // Tablas de Archivos
            'MNU_ARC_TAB_LOCALIDADES' => 'localidades',
            'MNU_ARC_TAB_ZONAS'       => 'zonas',
            'MNU_ARC_TAB_GRUPO_WEB'   => 'grupos-web',
            'MNU_ARC_TAB_EMPRESAS'    => 'empresas',
            'MNU_ARC_TAB_BANCOS'      => 'bancos',
            'MNU_ARC_TAB_CIERRE_AUM'  => 'cierre-aumentos-tabla',
            'MNU_ARC_TAB_PCT_AUM'     => 'pct-aumento',
            'MNU_ARC_TAB_GRP_CARTILLA'=> 'grupos-cartilla',
            'MNU_ARC_TAB_TIT_CARTILLA'=> 'titulo-cartilla',
            'MNU_ARC_TAB_CONC_INT'    => 'conceptos-internacion',
            'MNU_ARC_TAB_PROC_INT'    => 'procesos-internacion',
            'MNU_ARC_TAB_TIPO_CERT'   => 'tipos-certificados',
            'MNU_ARC_TAB_VAL_VENTA'   => 'valores-venta',
            'MNU_ARC_TAB_CTRL_WEB'    => 'control-web',
            'MNU_ARC_TAB_URL_REF'     => 'url-referencias',
            'MNU_ARC_TAB_TIPOS_CX'    => 'tipos-cx',
            'MNU_ARC_TAB_SUBCAT'      => 'subcategorias',
            'MNU_ARC_TAB_REP_LEY'     => 'reportes-leyendas',
            'MNU_ARC_TAB_HOMOL'       => 'homologacion',
            'MNU_ARC_TAB_GRP_AUT'     => 'grupos-autorizaciones',
            'MNU_ARC_TAB_MOT_DEB'     => 'motivos-debitos',
            'MNU_ARC_TAB_GRP_NN'      => 'grupos-nomenclador',
            'MNU_ARC_TAB_SUBGRP_NN'   => 'subgrupos-nomenclador',
            'MNU_ARC_TAB_AJ_IMP'      => 'ajustes-impuestos',
